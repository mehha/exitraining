...
if( function_exists('acf_add_options_page') ):
    ...
    acf_add_options_sub_page('Contact form');

    acf_add_local_field_group(array (
        'key' => 'group_5besasa8c49f59e',
        ...
        'fields' => array (
            ...
            array (
                'key' => 'field_5be3a3asassdaass',
                'label' => 'Airtable database',
                'name' => 'airtable_database',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
